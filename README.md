...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.20580179.svg)](https://doi.org/10.5281/zenodo.20580179)
...
@software{joshi2025geopolysimplify,
  ...
  version   = {1.0.0},
  publisher = {Zenodo},
  doi       = {10.5281/zenodo.20580179,
  url       = {https://doi.org/10.5281/zenodo.20580179}
}
```
